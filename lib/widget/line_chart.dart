...
class TransactionHistoryLineChartCard extends StatelessWidget {
  TransactionHistoryLineChartCard({super.key, required this.title});
  ...
  final List<FlSpot> spots = const [
    ...
    FlSpot(4, 18),
    FlSpot(5, 22),
    // Add more data points based on your transaction history
  ];
  ...
  final bottomTitle = {
    ...
    3: 'Apr',
    4: 'May',
    // Add more months based on your transaction history
  };
